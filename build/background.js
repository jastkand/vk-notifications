...
(function() {
  var displayAnError, getUrlParameterValue, groupPosts, listenerHandler, loadByUrl, postsCount, processData, processPosts, processSingleRequest, prosessArrayOfRequests, updatePosts;
  ...
  processSingleRequest = function(posts) {
    ...
    if (posts[0].response[0] !== 0) {
      postsCount[groupId] = posts[0].response[0];
    }
